                          ...
                          <div class="card">
                            <div class="card-body">
                              <div class="d-flex flex-column align-items-center text-center">
                                <img src="https://www.kindpng.com/picc/m/171-1712282_profile-icon-png-profile-icon-vector-png-transparent.png" alt="Admin" class="rounded-circle" width="150">
                                <div class="mt-3">
                                  <h4>${usr.userName}</h4>
                                  <p class="text-secondary mb-1">${usr.email}</p>
                                  <p class="text-muted font-size-sm">  ${usr.country }</p>
                                </div>
                              </div>
                            </div>
                          </div>    
                        ...
                        <div class="col-md-8">
                          <div class="card mb-3">
                            <div class="card-body">
                              ...
                              <div class="row">
                                <div class="col-sm-12">
                                  <a class="btn btn-info " target="__blank" href="update/${usr.userid}">Edit</a>
                                </div>
                              </div>
                            </div>
                          </div>      
