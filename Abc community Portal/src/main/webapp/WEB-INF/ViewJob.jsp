...
<header class="tm-header" id="tm-header">
    <div class="tm-header-wrapper">
        ...
        <div class="tm-site-header">
            ...
            <h1 class="text-center">ABC<br>ADMIN</h1>
        </div>
        <nav class="tm-nav" id="tm-nav">            
            <ul>
               
                <li class="tm-nav-item"><a href="/admin" class="tm-nav-link">
                    ...
                    <div class="container">
                        <div class="card mt-5 border-5 pt-2 active pb-0 px-3">
                            <div class="card-body ">
                                <div class="row">
                                    <div class="col-12 ">
                                        <h4 class="card-title "><b style="font-size: 3vh;">${showJobs.job_Title}</b></h4>
                
                                    </div>
                                    <div class="col">
                                        <h6 class="card-subtitle mb-2 text-muted">
                                            <p class="card-text text-muted small " style="font-size: 2vh;">
                                               
                
                                                 by <span class="font-weight-bold">${showJobs.company}</span> ${showJobs.author}</p>
                                        </h6>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class=" col-md-auto ">
                                        <a href="#" class="btn btn-outlined btn-black text-muted bg-transparent"
                                            data-wow-delay="0.7s"><img src="https://img.icons8.com/external-kiranshastry-solid-kiranshastry/344/external-rupees-ecommerce-kiranshastry-solid-kiranshastry.png"
                                                width="19" height="19"> <small style="font-size: 2vh;">${showJobs.salary}</small></a>
                                        ...
                                        <a href="#" class="
                                         btn-outlined btn-black text-muted"><img src="https://img.icons8.com/external-phatplus-lineal-phatplus/344/external-id-school-phatplus-lineal-phatplus.png"
                                                width="17" height="17" id="plus">
                                            <small style="font-size: 2vh;">${showJobs.job_Id}</small> </a>
                
                
                                        <a href="/jobDetails/${showJobs.job_Id}" class="btn btn-outlined btn-black text-muted "><img
                                                src="https://img.icons8.com/metro/26/000000/more.png" width="20" height="20"
                                                class="mr-2 more"><small style="font-size: 2vh;">MORE</small></a>
