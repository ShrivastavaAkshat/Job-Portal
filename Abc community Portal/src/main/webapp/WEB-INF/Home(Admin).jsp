...
.tm-nav-item:hover .tm-nav-link1,
...
.tm-nav-link1 i { margin-right: 37px; }
ul { 
    margin: 0; 
    padding: 0;
}
	...
	<header class="tm-header" id="tm-header">
        <div class="tm-header-wrapper">
            ...
            <div class="tm-site-header">
                ...
                <h1 class="text-center">ABC Admin</h1>
               </div>
            <nav class="tm-nav" id="tm-nav">            
                <ul>
                    <li class="tm-nav-item active">
                        <i class="fas fa-home"></i><a href="Home(Admin).jsp" class="tm-nav-link">
                        Home
                    </a></li>
                ...
                <article class="col-12 col-md-6 tm-post">
                    ...
                    <nav class="tm-nav" id="tm-nav">            
                        <ul>
                            ...
                            <li class="tm-nav-item"><a href="register" class="tm-nav-link1">
                                <i class="fas fa-pen"></i>
                                Add User
                            </a></li>
                            <li class="tm-nav-item"><a href="show" class="tm-nav-link1">
                                <i class="fas fa-pen"></i>
                                 View All Users
                            </a></li>
                            <li class="tm-nav-item"><a href="/createjobs" class="tm-nav-link1">
                                <i class="fas fa-pen"></i>
                                 Add Jobs
                            </a></li>             
                            <li class="tm-nav-item"><a href="/viewjobs" class="tm-nav-link1">
                                <i class="fas fa-pen"></i>
                                 View Jobs
                            </a></li>                  
                        </a></li>             
                        <li class="tm-nav-item"><a href="/sendEmail" class="tm-nav-link1">
                            <i class="fas fa-pen"></i>
                            Mails
                        </a></li>                  
                    </ul>
