...
<body  >
  ...
  <section id="hero">
    <div class="hero-container" data-aos="fade-up">
      ...
      <h2>We are team of DEV</h2>
      <a href="register" class="btn-get-started scrollto">SIGN UP<i class="bx bx-chevrons-down"></i></a>
      <a href="login" class="btn-get-started scrollto">LOG IN<i class="bx bx-chevrons-down"></i></a>
    </div>
  </section><!-- End Hero -->
